...
// Recibe organizationId/orgName ya resueltos por el servidor (page.tsx) en
// vez de leer el query param en el cliente — así el HTML servido coincide
// exactamente con lo que el navegador hidrata, sin depender de
// useSearchParams()/Suspense en una ruta que de otro modo sería estática.
